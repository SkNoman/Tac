package com.etac.service.utils.MotionToast
...
import com.etac.service.databinding.FullColorToastBinding
import com.etac.service.databinding.MotionToastBinding
import www.sanju.motiontoast.MotionToastStyle

class MotionToastCustom {
    companion object {
            ...
            when (style) {
                ...
                MotionToastStyle.SUCCESS -> {
                    binding.customToastImage.setImageDrawable(
                        ContextCompat.getDrawable(
                                context,
                                www.sanju.motiontoast.R.drawable.ic_check_green
                        )
                    )
                    ...
                    binding.customToastText.visibility = View.GONE
                ...
                MotionToastStyle.ERROR -> {
                    binding.customToastImage.setImageDrawable(
                        ContextCompat.getDrawable(
                                context,
                                www.sanju.motiontoast.R.drawable.ic_error_
                        )
                    )
                    DrawableCompat.setTint(
                        DrawableCompat.wrap(binding.customToastImage.drawable),
                ...
                MotionToastStyle.WARNING -> {
                    binding.customToastImage.setImageDrawable(
                        ContextCompat.getDrawable(
                                context,
                                www.sanju.motiontoast.R.drawable.ic_warning_yellow
                        )
                    )
                    DrawableCompat.setTint(
                        DrawableCompat.wrap(binding.customToastImage.drawable),
                ...
                MotionToastStyle.INFO -> {
                    binding.customToastImage.setImageDrawable(
                        ContextCompat.getDrawable(
                                context,
                                www.sanju.motiontoast.R.drawable.ic_info_blue
                        )
                    )
                    DrawableCompat.setTint(
                        DrawableCompat.wrap(binding.customToastImage.drawable),
                ...
                MotionToastStyle.DELETE -> {
                    binding.customToastImage.setImageDrawable(
                        ContextCompat.getDrawable(
                                context,
                                www.sanju.motiontoast.R.drawable.ic_delete_
                        )
                    )
                    DrawableCompat.setTint(
                        DrawableCompat.wrap(binding.customToastImage.drawable),
...
//                    binding.animate().alpha(0f).duration = 3000
                ...
                MotionToastStyle.NO_INTERNET -> {
                    binding.customToastImage.setImageDrawable(
                        ContextCompat.getDrawable(
                            context,
                            www.sanju.motiontoast.R.drawable.ic_no_internet
                        )
                    )
                    DrawableCompat.setTint(
                        DrawableCompat.wrap(binding.customToastImage.drawable),
        ...
        fun darkColorToast(
            ...
            when (style) {
                ...
                MotionToastStyle.SUCCESS -> {
                    ...
                    binding.customToastText.text = title
                       // if (title.isNullOrBlank()) MotionToastStyle.SUCCESS.getName() else title
                ...
                MotionToastStyle.ERROR -> {
                    ...
                    binding.customToastText.text = title
                    binding.customToastText.visibility = View.GONE
                        //if (title.isNullOrBlank()) www.sanju.motiontoast.MotionToastStyle.ERROR.getName() else title
                ...
                MotionToastStyle.WARNING -> {
                    ...
                    binding.customToastText.text = title
                        //if (title.isNullOrBlank()) www.sanju.motiontoast.MotionToastStyle.WARNING.getName() else title
                ...
                MotionToastStyle.INFO -> {
                    ...
                    binding.customToastText.text = title
                        //if (title.isNullOrBlank()) www.sanju.motiontoast.MotionToastStyle.INFO.getName() else title
                ...
                MotionToastStyle.DELETE -> {
                    ...
                    binding.customToastText.text = title
                        //if (title.isNullOrBlank()) www.sanju.motiontoast.MotionToastStyle.DELETE.getName() else title
                ...
                MotionToastStyle.NO_INTERNET -> {
                    ...
                    binding.customToastText.text = title
                        //if (title.isNullOrBlank()) www.sanju.motiontoast.MotionToastStyle.NO_INTERNET.getName() else title
